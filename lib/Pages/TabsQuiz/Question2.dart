...
class Question2PageScreem extends StatelessWidget {
  PageController pageController;

  Question2PageScreem(this.pageController);
        ...
        Row(
          ...
          children: <Widget>[
            Container(
                ...
                width: 250,
                child: Text(
                  "Você teve ou está com tosse seca?",
                  style: TextStyle(
                      fontSize: 25,
        ...
        Row(
          ...
          children: <Widget>[
            RaisedButton(
              ...
              onPressed: (){
                symptoms++;
                pageController.animateToPage(3, duration: Duration(seconds: 1), curve: Curves.ease);
