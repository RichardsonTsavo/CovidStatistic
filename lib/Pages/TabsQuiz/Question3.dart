...
class Question3PageScreem extends StatelessWidget {
  PageController pageController;

  Question3PageScreem(this.pageController);
        ...
        Row(
          ...
          children: <Widget>[
            Container(
                ...
                width: 250,
                child: Text(
                  "Você em algum momento teve perda de olfato ou paladar?",
                  style: TextStyle(
                      fontSize: 25,
        ...
        Row(
          ...
          children: <Widget>[
            RaisedButton(
              ...
              onPressed: (){
                symptoms++;
                pageController.animateToPage(4, duration: Duration(seconds: 1), curve: Curves.ease);
              },
