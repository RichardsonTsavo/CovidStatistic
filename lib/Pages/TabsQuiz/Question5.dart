...
class Question5PageScreem extends StatelessWidget {
  PageController pageController;

  Question5PageScreem(this.pageController);
        ...
        Row(
          ...
          children: <Widget>[
            Container(
                ...
                width: 250,
                child: Text(
                  "Você se sente mais cansado que o normal?",
                  style: TextStyle(
                      fontSize: 25,
        ...
        Row(
          ...
          children: <Widget>[
            RaisedButton(
              ...
              onPressed: (){
                symptoms++;
                pageController.animateToPage(6, duration: Duration(seconds: 1), curve: Curves.ease);
              },
