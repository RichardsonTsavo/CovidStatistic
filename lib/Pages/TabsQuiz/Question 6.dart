...
class Question6PageScreem extends StatelessWidget {
  PageController pageController;

  Question6PageScreem(this.pageController);
        ...
        Row(
          ...
          children: <Widget>[
            Container(
                ...
                width: 250,
                child: Text(
                  "Você sentiu ou está sentindo dor de cabeça?",
                  style: TextStyle(
                      fontSize: 25,
        ...
        Row(
          ...
          children: <Widget>[
            RaisedButton(
              ...
              onPressed: (){
                symptoms++;
                pageController.animateToPage(7, duration: Duration(seconds: 1), curve: Curves.ease);
              },
